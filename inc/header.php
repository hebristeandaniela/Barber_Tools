...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url ?>plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css">
    ...
    overflow: hidden; /* Adăugat pentru a preveni depășirea conținutului */
}
...
#main-header:after {
    ...
    width: 100%;
    height: 100%;
    background: linear-gradient(to bottom, rgba(0, 0, 128, 0.6), rgba(0, 0, 64, 0.6)); /* Gradient albastru mai închis */
    z-index: -1;
}
