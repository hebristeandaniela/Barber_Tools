    ...
    <div class="container px-4 px-lg-5 my-5">
        ...
        <div class="row gx-4 gx-lg-5 align-items-center">
            ...
            <div class="col-md-6">
                ...
                <div class="fs-5 mb-5">
                 <span id="price"><?php echo isset($inv[0]['price']) ?  format_num($inv[0]['price']).' RON': "--" ?></span>
                <br>
                <span><small><span class="text-muted">Stoc Disponibil:</span> <span id="avail"><?php echo isset($inv[0]['stock']) ? format_num($inv[0]['stock']) : "--" ?></span></small></span>
                ...
                <a class="card product-item text-reset text-decoration-none" href=".?p=view_product&id=<?php echo md5($row['id']) ?>">
                    ...
                    <div class="card-body p-4">
                        <div class="">
                            ...
                            <p class="m-0"><small><span class="text-muted">Categoria:</span> <?php echo $row['category'] ?></small></p>
                        </div>
                    </div>
                </a>
            </div>
            ...
            $.ajax({
                ...
                success:function(resp){
                    if(typeof resp == 'object' && resp.status=='success'){
                        alert_toast("Produs adăugat în coș.",'success')
