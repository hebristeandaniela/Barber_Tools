                ...
                success: function(resp) {
                    if (resp) {
                        ...
                        if (resp.status == 'success') {
                            ...
                            var _frm = $('#login-frm')
                            var _msg = "<div class='alert alert-danger text-white err_msg'><i class='fa fa-exclamation-triangle'></i>Numele de utilizator sau parola incorectă</div>"
                            _frm.prepend(_msg)
        ...
        $.ajax({
            ...
            success: function(resp) {
                if (resp.status == 'success') {
                    ...
                    $('#msg').html('<div class="alert alert-danger err_msg">A apărut o eroare!</div>')
                }
                end_loader()
            }
        })
