...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		<div class="card-header">
			<h5 class="card-title">Informatii despre sistem</h5>
		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="short_name" class="control-label">Nume scurt de sistem</label>
					<input type="text" class="form-control form-control-sm" name="short_name" id="short_name" value="<?php echo  $_settings->info('short_name') ?>">
				</div>
			<div class="form-group">
				<label for="" class="control-label">Despre noi</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Politica de confidențialitate</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Logo-ul sistemului</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Coperta site-ului</label>
				<div class="custom-file">
			...
			<div class="form-group">
				<label for="" class="control-label">Imagini banner</label>
				<div class="custom-file">
				...
				<small><i>Alegeți să încărcați noi imagini banner</i></small>
			</div>
			<?php 
		...
		<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary" form="system-frm">Actualizează</button>
				</div>
			</div>
		</div>
...
<script>
	...
	function delete_img($path){
        ...
        $.ajax({
            ...
            error:err=>{
                console.log(err)
                alert_toast("A apărut o eroare! în timp ce ștergeți o imagine","error");
                end_loader()
            },
	...
	$(document).ready(function(){
		$('.rem_img').click(function(){
            _conf("Sigur ștergeți această imagine definitiv?",'delete_img',["'"+$(this).attr('data-path')+"'"])
        })
