...
<div class="card card-outline card-primary">
		...
		<div class="container-fluid">
			...
			<form action="" id="manage-user">	
				...
				<div class="form-group">
					...
					<small><i>Lăsați necompletat dacă nu doriți să schimbați parola.</i></small>
				</div>
				<div class="form-group">
	...
	<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary" form="manage-user">Actualizează</button>
				</div>
			</div>
		</div>
</div>
		...
		$.ajax({
			...
			success:function(resp){
				if(resp ==1){
					...
					$('#msg').html('<div class="alert alert-danger">Numele de utilizator există deja</div>')
					end_loader()
				}
			}
		})
