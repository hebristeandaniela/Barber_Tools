...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?>Creează</h3>
	</div>
	<div class="card-body">
		<form action="" id="package-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
			<div class="form-group">
				<label for="title" class="control-label">Titlul pachetului</label>
                <textarea name="title" id="" cols="30" rows="2" class="form-control form no-resize"><?php echo isset($title) ? $title : ''; ?></textarea>
			</div>
            <div class="form-group">
				<label for="tour_location" class="control-label">Locația turului</label>
            ...
            <div class="form-group">
				<label for="cost" class="control-label">Preț</label>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="package-form">Salvează</button>
		<a class="btn btn-flat btn-default" href="?page=responses">Închide</a>
	</div>
</div>
<script>
