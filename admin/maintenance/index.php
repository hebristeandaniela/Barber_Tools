...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Pachete</h3>
		<div class="card-tools">
			<a href="?page=packages/manage" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Creează</a>
		</div>
	</div>
	<div class="card-body">
							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item" href="?page=packages/manage&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Editează</a>
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Sunteți sigur că veți șterge definitiv acest pachet?","delete_package",[$(this).attr('data-id')])
		})
		$('.table').dataTable();
	})
