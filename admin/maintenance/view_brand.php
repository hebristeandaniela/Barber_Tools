...
<div class="container-fluid">
    ...
    <dl>
        <dt class="muted">Nume Brand</dt>
        <dd class="pl-4"><?= isset($name) ? $name : "" ?></dd>
        <dt class="muted">Descriere</dt>
    ...
    <div class="text-right">
        <button class="btn btn-dark btn-flat btn-sm" type="button" data-dismiss="modal"><i class="fa fa-times"></i> Închide</button>
    </div>
</div>