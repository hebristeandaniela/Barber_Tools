...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?> Produs</h3>
	</div>
	<div class="card-body">
		<form action="" id="product-form">
            ...
            <div class="form-group">
                ...
                <option value="" selected="" disabled="">Selectați Prima categorie</option>
                <?php
			...
			<div class="form-group">
				<label for="product_name" class="control-label">Nume Produs</label>
            ...
            <div class="form-group">
				<label for="" class="control-label">Imagini</label>
	...
	<div class="card-footer">
		...
		<a class="btn btn-flat btn-default" href="?page=product">Închide</a>
	</div>
</div>
<script>
	...
	$(document).ready(function(){
        ...
        $('#category_id').change(function(){
            ...
            $('#sub_category_id').select2({placeholder:"Vă rugăm să selectați aici",width:"relative"})
        })
        $('.select2').select2({placeholder:"Vă rugăm să selectați aici",width:"relative"})
