...
<div class="card card-primary card-outline">
    <div class="card-header">
        <h5 class="card-title">Raport de vânzări</h5>
    </div>
    <div class="card-body">
        <form id="filter-form">
            <div class="row align-items-end">
                <div class="form-group col-md-3">
                    <label for="date_start">Data Începerii</label>
                    <input type="date" class="form-control form-control-sm" name="date_start" value="<?php echo date("Y-m-d",strtotime($date_start)) ?>">
                </div>
                <div class="form-group col-md-3">
                    <label for="date_start">Data Sfârșitului</label>
                    <input type="date" class="form-control form-control-sm" name="date_end" value="<?php echo date("Y-m-d",strtotime($date_end)) ?>">
                </div>
                <div class="form-group col-md-1">
                    <button class="btn btn-flat btn-block btn-primary btn-sm"><i class="fa fa-filter"></i> Filtru</button>
                </div>
                <div class="form-group col-md-1">
                    <button class="btn btn-flat btn-block btn-success btn-sm" type="button" id="printBTN"><i class="fa fa-print"></i> Printează</button>
                </div>
            </div>
        </form>
        <hr>
        <div id="printable">
            <div class="row row-cols-2 justify-content-center align-items-center" id="print_header" style="display:none">
                ...
                <div class="col-7">
                    ...
                    <h3 class="text-center m-0"><b>Raport de vânzări</b></h3>
                    <?php if($date_start != $date_end): ?>
                    <p class="text-center m-0">Data Între <?php echo date("M d,Y", strtotime($date_start)) ?> și <?php echo date("M d,Y", strtotime($date_end)) ?></p>
                    <?php else: ?>
                    <p class="text-center m-0">Începând cu <?php echo date("M d,Y", strtotime($date_start)) ?></p>
                    <?php endif; ?>
                </div>
            </div>
            <hr>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="m-0"><small>Categoria: <?php echo $roww['category'] ?></small></p>
                        </td>
                        <td>
                ...
                <tfoot>
                    <tr>
                        <th colspan="7" class="font-weight-bold text-center">VANZARI TOTALE</th>
