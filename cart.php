    ...
    <div class="container">
        <div class="row">
            <div class="col d-flex justify-content-end mb-2">
                <button class="btn btn-outline-dark btn-flat btn-sm" type="button" id="empty_cart">Golește coșul</button>
            </div>
        </div>
        <div class="card rounded-0">
            <div class="card-body">
                <h3><b>Coșul de cumpărături</b></h3>
                    ...
                    <div class="d-flex w-100 justify-content-between  mb-2 py-2 border-bottom cart-item">
                        <div class="d-flex align-items-center col-8">
                            ...
                            <div>
                                ...
                                <p class="mb-1 mb-sm-1"><small><b>Preț:</b> <span class="price"><?php echo format_num($row['price']).' RON' ?></span></small></p>
                                <div>
        ...
        <div class="d-flex w-100 justify-content-end">
            <a href="./?p=checkout" class="btn btn-sm btn-flat btn-dark">Finalizare comandă</a>
        </div>
    </div>
</section>
<script>
    ...
    $(function(){
        ...
        $('#empty_cart').click(function(){
            // empty_cart()
            _conf("Ești sigur că vrei să ștergi produsele din coș?",'empty_cart',[])
        })
        $('.rem_item').click(function(){
            _conf("Ești sigur că vrei să elimini acest produs din coș?",'rem_item',[$(this).attr('data-id')])
        })
    })
</script>