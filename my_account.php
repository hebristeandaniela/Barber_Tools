        ...
        <div class="card rounded-0">
            <div class="card-body">
                <div class="w-100 justify-content-between d-flex">
                    <h4><b>Comenzile</b></h4>
                    <a href="./?p=edit_account" class="btn btn btn-default btn-flat text-white" style="background-image: linear-gradient(to bottom, #004c99, #001a33);"><div class="fa fa-user-cog"></div> Gestionează contul</a>
                </div>
                    ...
                    <table class="table table-stripped text-dark">
                        ...
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Data</th>
                                <th>Codul de referință al tranzacției</th>
                                <th>Suma</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo number_format($row['amount']).' RON' ?> </td>
                                    <td class="text-center">
                                            <?php if($row['status'] == 0): ?>
                                                <span class="badge badge-light text-dark border px-3 rounded-pill">În așteptare</span>
...
<script>
    ...
    $(function(){
        $('.view_order').click(function(){
            uni_modal("Istoric Comenzi","./admin/orders/view_order.php?view=user&id="+$(this).attr('data-id'),'large')
        })
        $('table').dataTable();
